...
<title>ＤＲＳ ユーザーズマニュアル Ｖ２．５（Python版）</title>
<style>
:root {
  --primary: #2563eb;
  --primary-dark: #1d4ed8;
...
.step .note::before { content: '注：'; font-weight: 700; }
/* ===== ALERTS ===== */
.alert {
...
.alert-warn { background: var(--accent-light); border-left: 4px solid var(--accent); color: #92400e; }
